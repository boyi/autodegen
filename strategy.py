    ...
    def on_bar(self, bar, portfolio):
        ...
        if current_pos == 0:
            ...
            if crossover_entry or reentry:
                ...
                if fc is not None and fc == fc:
                    size *= max(0.30, min(1.70, 1.15 - fc * 50.0))
                ...
                macro_factor = max(0.005, min(1.0, 1.0 + macro_gap * 130.0))
                size *= macro_factor
        ...
        if current_pos > 0:
            ...
            if volz_tp is not None and volz_tp == volz_tp:
                tp_pct = max(0.02, min(0.07, tp_pct + volz_tp * 0.0200))
