        ...
        if current_pos == 0:
            ...
            if crossover_entry or reentry:
                ...
                if fc is not None and fc == fc:
                    size *= max(0.30, min(1.70, 1.09 - fc * 50.0))
                ...
                macro_factor = max(0.01, min(1.0, 1.0 + macro_gap * 100.0))
                size *= macro_factor
        ...
        if current_pos > 0:
            ...
            if (not self.took_profit
                ...
                if pbr is not None and pbr == pbr:
                    tp_frac = max(0.001, min(0.998, 1.12 - pbr * 1.40))
